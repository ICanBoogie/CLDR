...
use ICanBoogie\CLDR\Numbers\CurrencyLocalized;
...
final class LocalizedCurrencyTest extends TestCase
{
    ...
    private static CurrencyLocalized $sut;

    public static function setUpBeforeClass(): void
    {
        self::$currency = Currency::of('IEP');
        self::$sut = new CurrencyLocalized(self::$currency, locale_for('fr'));
    }
    ...
    public function test_localize(): void
    {
        ...
        $this->assertInstanceOf(CurrencyLocalized::class, $localized);
    ...
    public function test_format(string $currency_code, string $locale_id, float|int $number, string $expected): void
    {
        ...
        $localized = new CurrencyLocalized($currency, locale_for($locale_id));
    ...
    public function test_format_accounting(
        ...
        $currency = Currency::of($currency_code);
        $localized = new CurrencyLocalized($currency, locale_for($locale_id));
        $actual = $localized->format($number, CurrencyFormatterLocalized::PATTERN_ACCOUNTING);
