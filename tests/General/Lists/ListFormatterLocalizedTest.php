...
namespace Test\ICanBoogie\CLDR\General\Lists;
...
final class ListFormatterLocalizedTest extends TestCase
{
    /**
    ...
    public function test_format(array $list, ListType $type, string $locale_id, string $expected): void
    {
        ...
        $lp = new ListFormatterLocalized(new ListFormatter(), $locale);
