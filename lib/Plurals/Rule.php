...
final class Rule
{
    public static function from(string $rule): Rule
    {
     ...
     */
    private static function parse_rule(string $rules): array
    {
     ...
     *      An array of 'OR' relations, where _value_ is an array of 'AND' relations.
     */
    private static function extract_relations(string $rule): array
    {
        return array_map(
